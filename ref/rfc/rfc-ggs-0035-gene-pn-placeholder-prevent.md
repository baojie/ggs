...
**Review**: faithful
**Date**: 2026-05-27
**调整说明**: RFC 原提案修改全部 34 个 NEW*/RCH* 文件。经确认，仅在三个入口 gene（NEW1/RCH1/RCH2）增加"前置读 LAW"节，引用 LAW.md §三（PN）和 §五（slug），覆盖所有建页/增补/升档流程。
**Commits**:
- baojie/memex@b5451bb9cc08145046a6fcd68efc53542b686f1c: feat(gene): NEW1/RCH1/RCH2 执行前读 LAW.md PN 和 slug 约定
